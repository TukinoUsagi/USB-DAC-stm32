...
/*
 * [変更] Blue Pill(RAM 20KB)向けにデフォルトの80から40へ削減。
 * USBD_AUDIO_FREQ=16000Hzの場合:
 *   AUDIO_OUT_PACKET = 16000*2*2/1000 = 64byte
 *   AUDIO_TOTAL_BUF_SIZE = 64 * 40 = 2560byte (約40msぶんのバッファ)
 * 80のままだと5120byteになり、他の変数やスタックを圧迫するため縮小した。
 */
...
USBD_AUDIO_HandleTypeDef *USBD_AUDIO_GetHandle(USBD_HandleTypeDef *pdev);
